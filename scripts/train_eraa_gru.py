...
def build_model(n_features: int, n_targets: int, hidden: int = 256, dropout: float = 0.1):
    ...
    return tf.keras.Model(inputs, outputs, name="eraa_gru_baseline")
...
def main():
    ...
    parser.add_argument("--output_dir", default="results_eraa_gru")
